...
EXRINCLUDE=-I/afs/ir/class/cs348b/exr/include/OpenEXR
EXRLIBDIR=-L/afs/ir/class/cs348b/exr/lib
EXRLIBS=$(EXRLIBDIR) -lIex -lIlmImf -lImath -lIex -lHalf -lz
ifeq ($(ARCH),Linux)
  EXRLIBS += -lpthread
endif
...
CORE         = api camera color dynload exrio film geometry light material mc \
               ...
               texture timer transform transport util volume pbrtparse pbrtlex bispectrum	
FILM         = image
...
MATERIALS    = bluepaint brushedmetal clay felt \
               ...
               shinymetal skin substrate translucent uber fluorescent
